...
# Abstract:
I reproduce some of the plots from Rstudio's [`{ggplot2}`](https://github.com/rstudio/cheatsheets/raw/master/data-visualization-2.1.pdf) cheat sheet using just the `qplot` function.
